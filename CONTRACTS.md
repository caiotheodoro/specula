# Specula — Benchmark & Scoring Contracts (FIXED)

These are the fixed contracts of the Specula benchmark. Changes require a
...
The oracle is the deterministic rule engine `specula_forge.verify`.
