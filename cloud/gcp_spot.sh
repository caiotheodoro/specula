...
NAME="labelforge-train-$(date +%m%d-%H%M)"
...
cd /root && git clone https://github.com/caiotheodoro/labelforge.git && cd labelforge
python3 -m labelforge_model.train --data data/train.jsonl 2>&1 | tee /root/train.log'
