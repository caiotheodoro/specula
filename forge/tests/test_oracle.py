...
from labelforge_forge.generate import _copy_nf, _pick_facts, task
from labelforge_forge.schema import NutritionFacts, ProductFacts, ViolationType
from labelforge_forge.verify import (
    DV_REF,
    oracle_gate,
    percent_dv,
    rounded_dv,
...
def test_all_validation_types_reachable_across_seed():
    ...
    import random as _r
    from labelforge_forge.verify import RACC
    rng = _r.Random(42)
